from .models import *
def cal_energy_sum(production, working_day, allocate, saving):
    # y = mx + b
    m = 0.414
    b = 281.459
    table = ''
    ...
    #     table = ZP_Cal
    #     ratio = Z_MAKE
    Z_MAKE.objects.filter(month='2021-10').values('tech_ratio')[0]
    var = production * m
    fix = working_day * b
